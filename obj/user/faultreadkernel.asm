	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001c4:	0f be 80 d5 10 80 00 	movsbl 0x8010d5(%eax),%eax
  8001cb:	50                   	push   %eax
  ...
  80025e:	0f be 80 d5 10 80 00 	movsbl 0x8010d5(%eax),%eax
  800265:	50                   	push   %eax
  ...
  8002c8:	0f be 80 d5 10 80 00 	movsbl 0x8010d5(%eax),%eax
  8002cf:	50                   	push   %eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  8003e2:	ff 24 85 e0 11 80 00 	jmp    *0x8011e0(,%eax,4)
  ...
  8004c3:	8b 14 85 38 13 80 00 	mov    0x801338(,%eax,4),%edx
  8004ca:	85 d2                	test   %edx,%edx
  8004cc:	75 15                	jne    8004e3 <vprintfmt+0x192>
				printfmt(putch, putdat, "error %d", err);
  8004ce:	50                   	push   %eax
  8004cf:	68 ed 10 80 00       	push   $0x8010ed
  8004d4:	53                   	push   %ebx
  8004d5:	57                   	push   %edi
  ...
  8004e3:	52                   	push   %edx
  8004e4:	68 f6 10 80 00       	push   $0x8010f6
  8004e9:	53                   	push   %ebx
  8004ea:	57                   	push   %edi
  ...
  800505:	b9 e6 10 80 00       	mov    $0x8010e6,%ecx
...
getint(va_list *ap, int lflag)
{
  ...
  800774:	68 64 11 80 00       	push   $0x801164
  800779:	68 f6 10 80 00       	push   $0x8010f6
  ...
  8007a0:	68 9c 11 80 00       	push   $0x80119c
  8007a5:	68 f6 10 80 00       	push   $0x8010f6
...
syscall(int num, int check, uint32_t a1, uint32_t a2, uint32_t a3, uint32_t a4, uint32_t a5)
{
  ...
  800d2e:	68 54 13 80 00       	push   $0x801354
  800d33:	6a 26                	push   $0x26
  800d35:	68 71 13 80 00       	push   $0x801371
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800dd2:	50                   	push   %eax
  800dd3:	68 7f 13 80 00       	push   $0x80137f
  ...
  800df4:	56                   	push   %esi
  800df5:	50                   	push   %eax
  800df6:	68 88 13 80 00       	push   $0x801388
  ...
  800e07:	e8 cc f2 ff ff       	call   8000d8 <vcprintf>
	cprintf("\n");
  800e0c:	c7 04 24 84 13 80 00 	movl   $0x801384,(%esp)
